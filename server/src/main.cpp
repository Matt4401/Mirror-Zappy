...
int main(int ac, char** av) {
    try {
        ...
        zappy::shared::parsing::Parser<zappy::shared::parsing::ServerConfig> parser(std::move(serverStrategy));
        const zappy::shared::parsing::ServerConfig config = parser.parse(ac, av);
