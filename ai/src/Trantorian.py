...
import random
from .util.BroadcastMessageManager import BroadcastMessage
...
class Trantorian:
    def __init__(self, port, host, team_name, player_id, bonus, connect_timeout=0.0):
